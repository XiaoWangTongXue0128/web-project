        ...
        <div class="loginBox" style="background:#fff;opacity:0.9">
            ...
            <div class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="uname" id="user-login-uname" lay-verify="required" placeholder="用户名" class="layui-input" value="${requestScope.user==null?'':requestScope.user.uname}">
                </div>
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="user-login-submit">保  存</button>
                </div>
