...
import org.duyi.mvc.exceptions.ResultTypeDisabledException;
...
public class MvcInterceptorChain {
    ...
    private boolean isSimpleResultType(Object result){
        ...
        return c == String.class || c == int.class || c==Integer.class || c==double.class || c==Double.class || c==long.class || c == Long.class ;
    }
